...
public class GeofenceWrapper {
    ...
    private GeofencingRequest getGeofeningRequest(){
    ...
    public void addLocationForMonitoring(LatLng latLng, float radius){
        geofenceList.add(
        ...
        mGeofencingClient.addGeofences(getGeofeningRequest(),getGeofencingPendingIntent())
